...
const Loading = ({ isClinic = false }) => {
    return (
        <div
            className={`fixed inset-0 flex justify-center items-center z-50 ${isClinic ? "bg-sky-50" : "bg-pink-50"
                }`}
        >
            <motion.div
            ...
            >
                ...
                <motion.div
                    className={`${isClinic ? "text-[#A4DEC6]" : "text-pink-600"
